...
namespace CSBasic
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(number2.ToString("0.0"));  // 52.3
            Console.WriteLine(number2.ToString("0.00"));  // 52.27
            Console.WriteLine(number2.ToString("0.000"));  // 52.273
            Console.WriteLine(number2.ToString("0.0000"));  //52.2731
